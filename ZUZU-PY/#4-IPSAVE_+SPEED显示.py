...
file_paths = ['K合并2H-SPEED.txt','K合并2H--低速线SPEED.txt','JX-LOW-SPEED.txt','JX-HIGH-SPEED.txt',"JIEXI-OK.txt"]  #把测速结果和JIEXI-OK.txt合并到一起
