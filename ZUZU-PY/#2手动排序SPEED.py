...
# 加载文件
file_paths = ["山西联通.txt", "安徽电信.txt", "北京联通.txt", "贵州电信.txt", "四川联通.txt", "四川电信.txt", "重庆联通.txt", "重庆电信.txt", "广东电信.txt", "广西电信.txt", "江西电信.txt", "河北电信.txt", "河南联通.txt", "浙江电信.txt", "湖北电信.txt", "辽宁联通.txt", "陕西电信.txt", "K合并OLD.txt"]
